    ...
    describe("about state", function() {
      ...
      describe("views", function() {
        ...
        describe("master", function() {
          ...
          it("should map to templateUrl \'app/core/main/templates/layout.html\'", function() {
            expect(master.templateUrl).toEqual('app/core/main/templates/layout.html');
          });
        ...
        describe("content", function() {
          ...
          it("should map to templateUrl \'app/modules/pages/about/templates/page.html\'", function() {
            expect(content.templateUrl).toEqual('app/modules/pages/about/templates/page.html');
          });
